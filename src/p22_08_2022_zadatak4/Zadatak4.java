...
metodu ucitajVideo kojoj se prosledjuje referenca do videa koji se pusta. Trenutno vreme kada se ucita video se postavlja na nulu. 
Treba videu da povecamo broj pregleda!
...
Objasnjenje v6tuOipj5mk je id videa.
	 */
		...
		Video v1 = new Video("DJQqWbvwpPg", "Ariana Grande and Cynthia Erivo - Wicked", 210);
		for (int i = 0; i < 100; i++) {
			v1.like();
			v1.dislike();
			v1.view();
		...
		YoutubePlayer a1 = new YoutubePlayer();
		a1.ucitajVideo(v1);
		a1.pojacaj();
		a1.pojacaj();
		a1.pojacaj();
		a1.postaviKvalitet(7);
		a1.aktivirajPrekoCelogEkranaMod();
		a1.premotajUnazad();
		a1.premotajUnapred();
		a1.premotajUnapred();
		a1.premotajUnapred();
